...
import org.kmtech.model.UrlSuggestionCursorAdapter.QueryBuilderListener;
...
public class TabletUrlBar extends LinearLayout implements UrlBar {
	...
	public TabletUrlBar(final Context context, AttributeSet attrs, int defStyle) {
    	...
    	mUrlTextWatcher = new TextWatcher() {
			...
			public void afterTextChanged(Editable s) {
				...
				//
				// Font path
		        String fontPath = "font/Zawgyi.ttf";
		        // Loading Font Face
